...
public class AdminUserController {
    ...
    public ApiResponse<Page<UserResponse>> getUsers(@RequestParam(required = false, defaultValue = "")
        ...
        return ApiResponse.<Page<UserResponse>>builder().status(200)
                .message("Users fetched successfully").data(response).build();
    }
    ...
    public ApiResponse<UserResponse> getUser(@PathVariable Long id) {
        ...
        return ApiResponse.<UserResponse>builder().status(200)
    ...
    public ApiResponse<UserResponse> createUser(@RequestBody @Valid CreateUserRequest request) {
        ...
        return ApiResponse.<UserResponse>builder().status(201).message("User created successfully")
                .data(response).build();
    }
    ...
    public ApiResponse<UserResponse> updateUser(@PathVariable Long id,
        ...
        return ApiResponse.<UserResponse>builder().status(200).message("User updated successfully")
                .data(response).build();
    }
    ...
    public ApiResponse<String> deleteUser(@PathVariable Long id) {
        ...
        return ApiResponse.<String>builder().status(200).message("User deleted successfully")
